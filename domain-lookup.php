...
<html>
<head>
<title>Whois Checker - Domain Lookup Tool</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
</head>

<body style="max-width: 1000px;margin: auto;background-color: #efefef">
<div style="padding: 30px; border: 1px solid #cccccc; text-align: center;margin: 30px;background-color: #fcfcfc">
    <h1>Whois Checker - Domain Lookup Tool</h1><br><hr><br>
	<form action="<?=$_SERVER['PHP_SELF'];?>">
	<p><b><label for="domain" style="font-size:20px;">Enter Domain or IP Address:</label></b><br><br> <input style="padding:8px; border:1px solid #999999;font-size: 19px;border-radius: 2px;" type="text" name="domain" id="domain" value="<?=$domain;?>"> <input style="padding:8px; border:1px solid #999999;font-size: 19px;cursor: pointer;border-radius: 2px;" type="submit" value="Check"></p>
	</form>
</div>
<div style="overflow-x: scroll; margin: 30px;margin-top:10px!important;padding: 30px; border: 1px solid #cccccc;font-size: 18px;color:#444;line-height: 1.8em;background-color: #fafafa">
	<?php
	if($domain) {
		$domain = trim($domain);
...
<div style="text-align:center;margin-left: 30px;margin-right:30px!important;margin-top:10px!important;padding: 30px; border: 1px solid #cccccc;font-size: 15px;color:#efefef;line-height: 1.8em;background-color: #999">TECHAntena.com</div>
</body>
</html>
